...
export default () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      customerName: 'Marketing & Customer engagement',
      customerTitle: '',
    },
    {
      imageSrc: Service,
    ...
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>
            You Choose Infinity CRM Functionality to Build
          </HeadingTitle>
          <HeadingDescription>
            Infinity Consulting services aim to use customer data fully and
            smartly, and create tools for customer experience management
            throughout different touchpoints.
          </HeadingDescription>
        </HeadingInfoContainer>
